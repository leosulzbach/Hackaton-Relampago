...
import { CardTipo } from '../Components/Cards/CardTipo';
            ...
            ml={"30rem"}>Adicionar</Button>
                ...
                p={"1rem"}
                    ...
                    {CadastroList.map((cadastro: any) => {
                        return (
                            <CardTipo id={cadastro.id} descricao={cadastro.descricao} situacao={cadastro.situacao} data_vencimento={cadastro.data_vencimento} prioridade={cadastro.prioridade} />
                        )
                        }
                        )
                    }
